...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="button" id="copyAddressButton" class="btn btn-primary">Copy Shipping Address to Billing Address</button>
					<?php } ?>
...
document.getElementById("copyAddressButton").addEventListener("click", function () {
	...
	var billingingAddress = {

    // Set the billing address fields to the values of the shipping address
    address:document.getElementById("billingaddress").value = shippingAddress.address;
    state:document.getElementById("bilingstate").value = shippingAddress.state;
    city:document.getElementById("billingcity").value = shippingAddress.city;
    pincode:document.getElementById("billingpincode").value = shippingAddress.pincode;
	};
